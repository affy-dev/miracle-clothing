  ...
  <div class="container">
    <div class="row">
      <div class="col-12 col-lg-3"> <a class="footer-logo text-white h2 mb-0" href="index.html">
              Eko<span class="text-primary">cart</span>
            </a>
        <p class="my-3 text-muted">Ekocart - Multi-purpose E-commerce Html5 Template Is fully responsible, Build whatever you like with the Ekocart, Ekocart is the creative, modern HTML5 Template suitable for Your business.</p>
    ...
    <div class="row text-muted align-items-center">
      <div class="col-md-7">Copyright ©2020 All rights reserved | This Template is made by <i class="lar la-heart text-primary heartBeat2"></i>  <u><a class="text-primary" href="#">ThemeHt</a></u>
      </div>
