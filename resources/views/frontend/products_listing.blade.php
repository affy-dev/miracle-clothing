    ...
    <div class="row">
      ...
      <div class="col-xl-3 col-lg-4 col-md-6 mt-8 mt-md-0">
        <div class="card product-card">
          ...
          <div class="card-info">
            <div class="card-body">
              <div class="product-title"><a class="link-title" href="product-left-image.html">Women Sweater</a>
              </div>
      ...
      <div class="col-xl-3 col-lg-4 col-md-6 mt-8 mt-lg-0">
        <div class="card product-card">
          ...
          <div class="card-info">
            <div class="card-body">
              <div class="product-title"><a class="link-title" href="product-left-image.html">Gold Framed Sunglasses</a>
              </div>
      ...
      <div class="col-xl-3 col-lg-4 col-md-6 mt-8 mt-lg-0">
        <div class="card product-card">
          ...
          <div class="card-info">
            <div class="card-body">
              <div class="product-title"><a class="link-title" href="product-left-image.html">Unpaired Running Shoe</a>
              </div>
      ...
      <div class="col-xl-3 col-lg-4 col-md-6 mt-8">
        <div class="card product-card">
          ...
          <div class="card-info">
            <div class="card-body">
              <div class="product-title"><a class="link-title" href="product-left-image.html">Luxury Fashion Bag</a>
              </div>
      ...
      <div class="col-xl-3 col-lg-4 col-md-6 mt-8">
        <div class="card product-card">
          ...
          <div class="card-info">
            <div class="card-body">
              <div class="product-title"><a class="link-title" href="product-left-image.html">Bright Hipster Cloth</a>
              </div>
      ...
      <div class="col-xl-3 col-lg-4 col-md-6 mt-8">
        <div class="card product-card">
          ...
          <div class="card-info">
            <div class="card-body">
              <div class="product-title"><a class="link-title" href="product-left-image.html">Men's Brand Tshirts</a>
              </div>
      ...
      <div class="col-xl-3 col-lg-4 col-md-6 mt-8">
        <div class="card product-card">
          ...
          <div class="card-info">
            <div class="card-body">
              <div class="product-title"><a class="link-title" href="product-left-image.html">Crewneck Sweatshirt</a>
              </div>
